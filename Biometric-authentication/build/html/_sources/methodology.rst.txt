...
The interdependencies among data collection, model training, and face recognition modules are illustrated in the overall system flowchart (Figure 15). The success of face recognition relies on proper training during the model training phase.
